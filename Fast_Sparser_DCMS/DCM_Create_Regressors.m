...
Ny    = size(y_GLM,1);%Get the number of columns
Nu    = size(DCM.b,3);
...
%If DCM.dt_flag == 'L', use the Fourier transform of the signal difference.
%If DCM.dt_flag == 'S', use the Fourier transform followed by multiplication by the imaginary coefficients.
